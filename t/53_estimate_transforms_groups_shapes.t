...
my $without = SVG::Estimate->new( file_path => 'var/shapes-groups-without-transforms.svg' );
$without->estimate;
my $with    = SVG::Estimate->new( file_path => 'var/shapes-groups-with-transforms.svg' );
$with->estimate;
